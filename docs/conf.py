...
latex_documents = [
    (master_doc, 'EDPCMentoringDatabase.tex', 'EDPC Mentoring Database Documentation',
     'EDPC', 'manual'),
]
...
man_pages = [
    (master_doc, 'edpcmentoringdatabase', 'EDPC Mentoring Database Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EDPCMentoringDatabase', 'EDPC Mentoring Database Documentation',
     author, 'EDPCMentoringDatabase', 'One line description of project.',
     'Miscellaneous'),
]
