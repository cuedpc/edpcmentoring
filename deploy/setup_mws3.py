...
schemacmd=". %s/env/bin/activate; %s/edpcmentoring/manage.py loaddata --settings edpcmentoring.settings_mws3 %s/edpcmentoring/rest/fixtures/rest/edpcmentoring_perms.json" % (filedir_path,filedir_path,filedir_path)
subprocess_cmd(schemacmd)
print "done\n"
